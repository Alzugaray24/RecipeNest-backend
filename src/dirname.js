...
export const getUserIdFromToken = (cookie) => {
  try {
    const cookieArray = cookie.split(";").map((cookie) => cookie.trim());
    ...
    console.error("Error al obtener el ID de usuario del token:", error);
